...
# Add starting Venue data
# db.session.execute(Venue.__table__.insert(), 
#     [
#         {
#         "id": 1,
...
# Add Artist data
# db.session.execute(Artist.__table__.insert(), [
#     {
#     "id": 4,
#     "name": "Guns N Petals",
#     "genres": ["Rock n Roll"],
...
# query = Venue.query.filter(Venue.address==None)
# query.delete()

db.session.execute(Show.__table__.insert(), 
[
    {
    "venue_id": 1,
    "artist_id": 4,
